...
知识库详情的“新增资料”页签改为资料入库向导。

流程：

1. 选择入库方式：手动录入或文件上传。
2. 设置资料属性：资料标题、目录、资料类型、资料主题、适用模块、审核状态、可信度、来源说明；售后资料显示可见部门配置。
3. 填写正文或选择文件：手动录入支持 Markdown / 普通文本；文件上传支持 `txt`、`md`、`csv`、`xls`、`xlsx`、`docx`。
4. 确认保存：确认资料属性、文件名或正文摘要后入库。
