...
export const quickStartSteps: HelpStep[] = [
  {
    ...
    description:
      "登录后先查看 /dashboard。这里已经是数据工作台，用来判断品牌表现、待处理事项、内容运营进度和模型覆盖情况。"
  },
  {
    title: "先看待处理事项",
    description:
    ...
    steps: [
      {
        title: "Dashboard",
        description:
          "数据工作台，用来查看品牌提及率、推荐率、官网引用率、待处理事项、TOP 缺口、最近动态和快捷入口。"
      },
      {
        title: "GEO 诊断",
        description:
    ...
    steps: [
      {
        ...
        description:
          "Dashboard 会优先展示当前公司数据；接口暂未提供的数据会以示例或空状态标注，不能当成真实业务增长结果。"
      },
      {
