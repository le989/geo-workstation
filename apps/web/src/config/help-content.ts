...
export const quickStartSteps: HelpStep[] = [
  ...
  },
  {
    title: "建立知识库",
    description:
      "在 /knowledge-bases 沉淀产品、服务、案例、资质、FAQ、解决方案等可引用事实资料，并维护资料类型、可靠程度和资料状态。"
  },
  {
    title: "建立指令模板",
...
export const sopSections: HelpSection[] = [
  {
    ...
    steps: [
      ...
      },
      {
        title: "建立知识库",
        description:
          "按公司或产品线建立知识库，上传或手动录入真实资料，并设置资料类型、可靠程度、可用场景和资料状态。"
      },
      {
        title: "审核售后资料",
        description:
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        title: "知识库",
        description:
          "作为事实底座，支撑内容生成、售后问答和质量检查；资料需维护类型、资料状态和可靠程度。"
      },
      {
        title: "指令库",
  ...
  },
  {
    ...
    title: "知识库资料治理",
    summary:
      "知识库不只是文件库。资料入库时需要区分目录、资料类型、资料主题、可用场景和资料状态，售后资料还可以限制可见部门。",
    steps: [
      {
        title: "轻量入库",
        description:
      ...
      },
      {
        title: "展开高级资料属性",
        description:
          "需要细分主题、调整可用场景、资料状态、可靠程度、来源说明或售后可见部门时，再展开高级资料属性。"
      },
      {
        title: "选择资料类型",
        description:
      ...
      {
        title: "维护可靠程度和可用场景",
        description: "按资料来源设置高可靠、中可靠、低可靠，并选择内部检索、GEO 内容生成、售后问答或 GEO 分析等可用场景。"
      },
      {
        title: "筛选和判断引用状态",
        description:
          "资料列表支持卡片 / 表格视图切换，可按资料类型、资料主题、资料状态、可靠程度、可用场景和 AI 可引用状态筛选。"
      },
      {
        title: "配置售后资料可见部门",
    ...
    reminders: [
      ...
      "待审核和已停用资料不能作为售后问答依据。",
      "低可靠资料只用于内部查询，不会被售后问答或 GEO 内容生成正式引用。",
  ...
  },
  {
    ...
    steps: [
      {
        title: "准备已通过资料",
        description: "先在知识库中录入售后资料或产品资料，并确认资料状态为已通过。"
      },
      {
        title: "配置售后资料部门",
      ...
      },
      {
        title: "提交回答纠错",
        description:
          "每条系统回答下方可点击“回答有误”，选择错误类型并填写正确答案或补充说明，作为管理员复盘和知识库优化线索。"
      },
      {
        title: "处理反馈待办",
        description:
          "平台管理员和公司管理员可在售后问答页顶部切换到“反馈待处理”查看反馈详情，按需转为知识库待审核草稿，并标记已处理或无需处理。"
      },
      {
        title: "查看历史会话",
    ...
    reminders: [
      "售后问答不是客户开放版。",
      "不能当万能聊天机器人使用。",
      "反馈可由管理员整理后转为知识库待审核草稿，审核通过后才可能进入正式引用范围。",
      "转出的知识库草稿不会自动审核通过，也不会立即被 AI 正式引用。",
      "第一阶段不做物理删除、流式输出、Markdown 导出和图片/文件提问。",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        title: "知识库 / 文件 / 片段",
        description:
          "可软删除，适合处理错误、过期、测试或不应再引用的资料；资料也可以通过资料状态停用。"
      },
      {
        title: "指令模板",
    ...
    steps: [
      {
        title: "AI 模型覆盖记录",
        description:
          "支持编辑结果字段、软作废和恢复；作废记录默认不进入列表和报表统计，可通过筛选查看。"
      },
      {
        title: "AI 拓词历史",
      ...
      },
      {
        title: "售后问答",
        description:
          "当前只面向内部人员，不做客户开放版，不做自由聊天机器人；反馈可由管理员转为知识库待审核草稿。"
      },
      {
        title: "资料解析和额度",
...
export const versionNotes: VersionNote[] = [
  ...
  },
  {
    name: "知识库资料治理",
    capabilities: [
      "知识库资料支持轻量入库、高级资料属性折叠、资料类型、资料主题、资料状态、可靠程度、可用场景、售后资料可见部门、文件上传、手动录入和片段编辑。"
    ],
  ...
  },
  {
    name: "售后问答",
    capabilities: [
      "售后问答以左侧历史会话和右侧对话窗口承载，支持会话搜索、归档/恢复、加载更多和回答纠错反馈；基于已通过售后资料优先回答，未命中时用已通过产品资料兜底，并显示知识库、文件、片段和资料类型引用。"
    ],
    usage: "适合内部售后人员连续追问已有资料依据，无法找到可靠依据时提示补资料或转人工确认。",
    notes: "不是客户开放版，不是万能聊天机器人；反馈待处理仅管理员可见，可由管理员转为知识库待审核草稿。"
  },
  {
    name: "使用统计与操作日志",
    capabilities: [
