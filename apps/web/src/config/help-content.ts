...
export const sopSections: HelpSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        title: "提示词策略库",
        description:
          "维护训练词、蒸馏词、品牌词、场景词和真实用户会问 AI 的问题，并用业务价值和购买阶段辅助判断优先级。"
      },
      {
        title: "AI 拓词",
        description:
          "支持规则拓词和 AI 拓词。候选词会辅助展示问法类型、业务价值和购买阶段，人工确认后才保存到提示词策略库。"
      },
      {
        title: "企业知识库",
        description:
      ...
      },
      {
        title: "引用证据中心",
        description:
          "把问法、知识库、发布文章和模型覆盖记录串成只读证据链，用于判断哪些问题缺证据、缺文章或缺引用来源。"
      },
      {
        title: "竞品占位原因",
        description:
          "复盘 AI 回答中竞品出现、我方缺席或未被推荐的轻量原因，帮助判断下一步补问法、补证据、补文章还是复盘模型覆盖。"
      },
      {
        title: "GEO 报表",
        description:
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: "问法业务价值和购买阶段怎么看？",
        description:
          "问法库不是只存关键词。高意向问法适合优先监测和补证据；采购、对比、选型问题更接近 GEO 转化；认知问题适合基础内容覆盖；售后问题适合补 FAQ 和排查资料。"
      },
      {
        title: "引用证据中心里的引用来源是真的吗？",
        description:
          "轻量版只基于 smoke 数据和前端规则做只读聚合。显示“可能来源 / 待确认”时，不代表 AI 已真实引用；缺证据时先去知识库补资料，暂无文章时去发布文章工作台补引用友好内容，未推荐时去模型覆盖记录看原因。"
      },
      {
        title: "竞品占位原因是不是模型真实判断？",
        description:
          "不是。当前轻量版基于模型覆盖记录文本、竞品词库和已有未推荐原因做前端复盘，不代表 AI 官方判断；发现占位后优先补真实问法、可引用证据和引用友好文章，再复盘模型覆盖。"
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: "提示词策略库",
        description: "沉淀用户会如何向 AI 提问的问题，并维护词类型、产品线、优先级、业务价值和购买阶段。"
      },
      {
        title: "业务价值 / 购买阶段",
        description:
          "前端根据问法文本轻量推断高意向、中意向、低意向和认知、选型、对比、采购、售后阶段，用于运营排序参考，不等于正式商机评分。"
      },
      {
        title: "AI 拓词",
      ...
      },
      {
        title: "竞品占位原因",
        description:
          "基于覆盖记录文本和前端竞品词库做只读复盘，用于定位竞品出现、我方缺席和可能补救方向，结果需要人工确认。"
      },
      {
        title: "GEO 报表",
