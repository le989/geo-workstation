...
export const sopSections: HelpSection[] = [
  ...
  },
  {
    ...
    title: "售后问答",
    summary:
      "售后问答仅供内部使用，当前为对话式售后 AI 助手；左侧查看历史会话，右侧连续提问，有依据就显示引用，无依据就提示补资料或转人工确认。",
    steps: [
      {
        title: "准备已通过资料",
      ...
      },
      {
        title: "处理无依据回答",
        description:
          "如果提示“知识库中未找到可靠依据，建议补充资料或转人工确认。”，不要把它当作确定答案；问题过于模糊时需补充型号、现场现象、输出方式或接线情况。"
      },
      {
        title: "查看历史会话",
    ...
    reminders: [
      "售后问答不是客户开放版。",
      "不能当万能聊天机器人使用。",
      "第一阶段不做流式输出、回答纠错、反馈待处理、转知识库草稿、Markdown 导出和图片/文件提问。",
...
export const versionNotes: VersionNote[] = [
  ...
  },
  {
    name: "售后问答",
    capabilities: [
      "售后问答以左侧历史会话和右侧对话窗口承载，基于已通过售后资料优先回答，未命中时用已通过产品资料兜底，并显示知识库、文件、片段和资料类型引用。"
    ],
