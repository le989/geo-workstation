  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        title: "处理反馈待办",
        description:
          "平台管理员和公司管理员可在售后问答页顶部切换到“反馈待处理”查看反馈详情，并标记已处理或无需处理；第一版不会自动写入知识库。"
      },
      {
        title: "查看历史会话",
    ...
    reminders: [
      "售后问答不是客户开放版。",
      "不能当万能聊天机器人使用。",
      "反馈第一版只做记录和处理，不自动写入知识库，不生成知识库草稿。",
      "转知识库待审核资料草稿属于后续 AQA-KB-LOOP-1。",
      "第一阶段不做物理删除、流式输出、转知识库草稿、Markdown 导出和图片/文件提问。",
...
export const versionNotes: VersionNote[] = [
  ...
  },
  {
    ...
    notes: "不是客户开放版，不是万能聊天机器人；反馈待处理仅管理员可见，不自动写入知识库。"
  },
  {
    name: "使用统计与操作日志",
    capabilities: [
