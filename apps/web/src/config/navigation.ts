...
export const navigationItems: GeoPageMeta[] = [
  ...
  },
  {
    ...
    label: "日志与审计",
    title: "日志与审计",
    question: "系统操作和 AI 调用是否都有安全摘要可查？",
    description: "查看系统操作记录、AI 模块使用情况和底层接口调度流水。",
    phaseNote: "LOGS-VIEWER-UI-1C 只读展示安全摘要，不展示敏感正文、密钥或原始请求信息。",
    nextSteps: ["查看操作审计", "复盘业务 AI 记录", "排查底层接口日志"],
    apiFocus: "已联调 /api/logs-viewer/operation-logs、/ai-usage-records 和 /ai-call-logs",
    icon: DocumentChecked,
    allowedRoles: ["platform_admin", "company_admin"]
  },
  {
